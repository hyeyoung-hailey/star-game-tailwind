...
export default function Home() {
  ...
  return (
    <main className="relative flex flex-col items-center px-2 py-3 text-white overflow-hidden min-h-screen">
      ...
      {overlayVisible && (
        <>
          <div className="w-full text-center mt-2 sm:mt-10 absolute top-20 z-20">
          ...
          <div className="absolute bottom-60 w-full text-center z-20 text-white text-xs sm:text-[10px] leading-snug">
