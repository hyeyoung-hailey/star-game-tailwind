...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <link rel="preload" href="/end-A.png" as="image" />
        <link rel="preload" href="/end-B.png" as="image" />
        <link rel="preload" href="/end-C.png" as="image" />
        <link rel="preload" href="/end-D.png" as="image" />
        <link rel="preload" href="/end-E.png" as="image" />
      </Head>
          ...
          <>
            <div className="w-full text-center mt-6 sm:mt-10 absolute top-20 z-20">
              <h1 className="text-base sm:text-lg font-semibold text-white">
                {startLabel === 'A' &&
                  '추천 아이템 : Music Note Star-Back Black'}
